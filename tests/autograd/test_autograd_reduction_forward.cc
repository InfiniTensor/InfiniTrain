...
class AutogradReductionForwardTest : public infini_train::test::AutogradTestBase {};

TEST_F(AutogradReductionForwardTest, SumForward) {
...
TEST_F(AutogradReductionForwardTest, MeanForward) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradReductionForwardTest, MaxForward) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradReductionForwardTest, MinForward) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradReductionForwardTest, SumKeepDim) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradReductionForwardTest, MeanKeepDim) {
    auto a = createTensor({2, 3}, 1.0f);
