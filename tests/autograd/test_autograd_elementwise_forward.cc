...
TEST_F(AutogradElementwiseForwardTest, AddForward) {
...
TEST_F(AutogradElementwiseForwardTest, SubForward) {
...
TEST_F(AutogradElementwiseForwardTest, MulForward) {
...
TEST_F(AutogradElementwiseForwardTest, DivForward) {
...
TEST_F(AutogradElementwiseForwardTest, NegForward) {
    auto a = createTensor({2, 3}, 5.0f);
...
TEST_F(AutogradElementwiseForwardTest, SinForward) {
...
TEST_F(AutogradElementwiseForwardTest, CosForward) {
    auto a = createTensor({2, 3}, 0.0f);
...
TEST_F(AutogradElementwiseForwardTest, TanhForward) {
    auto a = createTensor({2, 3}, 0.0f);
...
TEST_F(AutogradElementwiseForwardTest, ExpForward) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradElementwiseForwardTest, LogForward) {
    auto a = createTensor({2, 3}, 2.0f);
...
TEST_F(AutogradElementwiseForwardTest, ReciprocalForward) {
    auto a = createTensor({2, 3}, 2.0f);
...
TEST_F(AutogradElementwiseForwardTest, PowForward) {
    auto a = createTensor({2, 3}, 2.0f);
...
TEST_F(AutogradElementwiseForwardTest, RsqrtForward) {
...
TEST_F(AutogradElementwiseForwardTest, SigmoidForward) {
    auto a = createTensor({2, 3}, 0.0f);
...
TEST_F(AutogradElementwiseForwardTest, AddScalarForward) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradElementwiseForwardTest, MulScalarForward) {
    auto a = createTensor({2, 3}, 2.0f);
...
TEST_F(AutogradElementwiseForwardTest, LtForward) {
    auto a = createTensor({2, 3}, 5.0f);
    auto b = createTensor({2, 3}, 3.0f);
...
TEST_F(AutogradElementwiseForwardTest, LeForward) {
...
TEST_F(AutogradElementwiseForwardTest, GtForward) {
    auto a = createTensor({2, 3}, 5.0f);
    auto b = createTensor({2, 3}, 3.0f);
...
TEST_F(AutogradElementwiseForwardTest, GeForward) {
    auto a = createTensor({2, 3}, 3.0f);
    auto b = createTensor({2, 3}, 3.0f);
...
TEST_F(AutogradElementwiseForwardTest, EqualsForward) {
    auto a = createTensor({2, 3}, 3.0f);
    auto b = createTensor({2, 3}, 3.0f);
...
TEST_F(AutogradElementwiseForwardTest, AndForward) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradElementwiseForwardTest, OrForward) {
    auto a = createTensor({2, 3}, 0.0f);
    auto b = createTensor({2, 3}, 1.0f);
