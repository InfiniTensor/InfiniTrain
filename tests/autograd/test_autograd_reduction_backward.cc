...
TEST_F(AutogradReductionBackwardTest, SumBackward) {
...
TEST_F(AutogradReductionBackwardTest, MeanBackward) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradReductionBackwardTest, MaxBackward) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradReductionBackwardTest, MinBackward) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradReductionBackwardTest, SumBackwardKeepDim) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradReductionBackwardTest, MeanBackwardKeepDim) {
    auto a = createTensor({2, 3}, 1.0f);
