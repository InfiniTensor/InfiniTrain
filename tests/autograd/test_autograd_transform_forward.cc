...
TEST_F(AutogradTransformForwardTest, TransposeForward) {
...
TEST_F(AutogradTransformForwardTest, SliceForward) {
...
TEST_F(AutogradTransformForwardTest, SplitForward) {
    auto a = createTensor({4, 4}, 1.0f);
...
TEST_F(AutogradTransformForwardTest, ConcatForward) {
...
TEST_F(AutogradTransformForwardTest, StackForward) {
    auto a = createTensor({2, 3}, 1.0f);
...
TEST_F(AutogradTransformForwardTest, TrilForward) {
...
TEST_F(AutogradTransformForwardTest, TriuForward) {
    auto a = createTensor({3, 3}, 1.0f);
