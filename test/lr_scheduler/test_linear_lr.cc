...
void TestFirstStepFromZero() {
    ...
    auto sched = LRScheduler::Create<LinearLR>(opt, /*start_factor=*/0.2f, /*end_factor=*/1.0f, /*total_iters=*/5);
...
void TestCustomStartFactor() {
    auto opt = MakeDummyOptimizer(kBaseLR);
    auto sched = LRScheduler::Create<LinearLR>(opt, /*start_factor=*/0.25f, /*end_factor=*/1.0f,
                                               /*total_iters=*/4);
