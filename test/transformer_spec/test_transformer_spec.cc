...
void test_gpt2_spec() {
    ...
    auto &last_stage = spec.submodules_["last_stage"];
...
void test_llama3_instantiation() {
    ...
    config.mlp_type = nn::MLPType::kSwiGLU;
