...
public:
    ...
    virtual std::vector<std::shared_ptr<Module>> GetPipelineLayers() { 
        printf("GetPipelineLayers 虚函数内\n");
        return {}; }

    virtual std::unordered_map<std::string, int64_t> GetConfig() const { 
        printf("GetConfig 虚函数内\n");
        return {}; }
